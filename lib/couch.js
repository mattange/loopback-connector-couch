(function() {
  ...
  CouchConnector = (function() {
    function CouchConnector(dataSource) {
      var authUrl, design, k, nano, settings, v, viewFn, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      if (settings.createDatabase) {
        authUrl = ((_ref3 = settings.auth) != null ? _ref3.admin : void 0) ? settings.auth.admin : settings.auth;
        nano = require('nano')(this.buildAuthUrl(authUrl, false));
        helpers.createDatabase(nano, this.settings.db, (function(_this) {
          return function(err, data) {
            return helpers.updateDesign(_this._nanoAdmin, '_design/loopback', design);
          };
        })(this));
      } else {
      ...
      if (settings.views && _.isArray(settings.views)) {
        ...
        if (dataSource.constructor.DataAccessObject) {
          _ref4 = dataSource.constructor.DataAccessObject;
          for (k in _ref4) {
            v = _ref4[k];
            this.DataAccessObject[k] = v;
          }
          _ref5 = dataSource.constructor.DataAccessObject.prototype;
          for (k in _ref5) {
            v = _ref5[k];
    ...
    CouchConnector.prototype.buildAuthUrl = function(auth, withDb) {
      var authString, url;
      if (withDb == null) {
        withDb = true;
      }
      ...
      url = this.settings.protocol + '://' + authString + this.settings.hostname + ':' + this.settings.port + '/' + (withDb ? this.settings.database : '');
      return url;
    };
  ...
  helpers = {
    ...
    createDatabase: function(nano, dbName, callback) {
      return nano.db.create(dbName, (function(_this) {
        return function(err, body) {
          if (err) {
